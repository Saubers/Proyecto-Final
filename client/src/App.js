...
console.log(isAdmin)
 ...
 <Route exact path="/" component={LandingPage} />
       {isAdmin !== '"inactive"' && <Route exact path="/home/Catalogo/:id" component={ProductDetail} />}
        {isAdmin !== '"inactive"' && <Route exact path="/home/CrearCategoria" component={CategoryCreate} />}
...
{  isAdmin !== '"inactive"' &&  ( <Route exact path='/home/compra' component={Cart} />)}
       {isAdmin !== '"inactive"' &&  <Route exact path='/home/ADMIN/orders' component={OrderCar}/>}
